 ...
 */
     ...
     // Для реального устройства Android 14
        capabilities.setCapability("platformName", "Android");
        capabilities.setCapability("deviceName", "996dc26c"); // ID из adb devices
        capabilities.setCapability("platformVersion", "15");
        capabilities.setCapability("automationName", "UiAutomator2");
        capabilities.setCapability("app", "C:/Autotests/JavaAppiumAutomation/ui_test/apks/app-prod.apk");
        capabilities.setCapability("appPackage", "com.novakid.student");
        capabilities.setCapability("appActivity", "com.novakid.student.MainActivity");
        capabilities.setCapability("newCommandTimeout", 300);
        capabilities.setCapability("adbExecTimeout", 60000);
