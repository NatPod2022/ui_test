...
public class SubscriptionTrialPageTest extends base.AppiumBaseTest {

    @Test
    // Test Case #16
    public void testSubscriptionTrialPageElements() throws InterruptedException {
        ...
        pages.testSubscriptionTrialPage.getBackButton();
        pages.testSubscriptionTrialPage.getTitlePackage();
        pages.testSubscriptionTrialPage.getTitleStandardPackage();
        pages.testSubscriptionTrialPage.getTitlePremium();
        pages.testSubscriptionTrialPage.getPrice1st();
        pages.testSubscriptionTrialPage.getTextOr();
        pages.testSubscriptionTrialPage.getTitleStandard();
        pages.testSubscriptionTrialPage.getPrice2nd();
        pages.testSubscriptionTrialPage.getTopUpBalanceButton();
    }
}
